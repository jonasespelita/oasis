...
document.write('<div id="header_'+this.id+'" style="overflow:hidden; overflow-x:hidden; overflow-y:scroll; background:#D4D4D4; height:20px;"><table border=0 cellpadding=0 cellspacing=0><tr>');
...
document.write('</tr></table></div><div id="'+id+'" style="overflow-y:scroll; overflow-x:hidden; border-bottom:1px solid #FFFFFF; border-top:1px solid #999999; background:#FFFFFF;"  onscroll="javascript:'+this.name+'.scrollme()"></div>');
document.write('<div id="scroll_'+id+'" style="height:16px; width: '+(this.width+299)+'px; overflow:auto; background:#D4D4D4;" onscroll="javascript:'+this.name+'.scrollme()">f</div></div>');
